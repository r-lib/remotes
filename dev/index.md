...
- For R newer than 3.3, default
  [`download.file()`](https://rdrr.io/r/utils/download.file.html) method
  is used. (`method = "auto"`)
...
See
[`help("download.file")`](https://rdrr.io/r/utils/download.file.html)
for information on these methods and for setting proxies if needed.
...
[`?options`](https://rdrr.io/r/base/options.html) for their details:
...
- Setting `R_REMOTES_NO_ERRORS_FROM_WARNINGS="false"` will cause warning
  messages during calls to
  [`install.packages()`](https://rdrr.io/r/utils/install.packages.html)
  to become errors. Often warning messages are caused by dependencies
  failing to install.
